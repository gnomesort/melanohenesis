...
@interface MGModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation MGModelController
...
{   
    ...
    MGDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"MGDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(MGDataViewController *)viewController];
